...
package testcompanysamplesdk45
...
import (
	...
	"github.com/speakeasy-sdks/TestCompany-sample-sdk-45/pkg/utils"
	"net/http"
	"time"
)
...
func New(opts ...SDKOption) *Speakeasy {
	sdk := &Speakeasy{
		sdkConfiguration: sdkConfiguration{
			...
			SDKVersion:        "0.7.0",
			GenVersion:        "2.183.0",
			UserAgent:         "speakeasy-sdk/go 0.7.0 2.183.0 1.0.0 github.com/speakeasy-sdks/TestCompany-sample-sdk-45",
			ServerDefaults: map[string]map[string]string{
				"prod":    {},
				"staging": {},
				"customer": {
